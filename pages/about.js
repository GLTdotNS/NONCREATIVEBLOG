      ...
      <div className="  h-full bg-opacity-50 mx-auto">
        <div className="text-left text-lg">
          ...
          <section class="container mx-auto px-4 py-8 flex flex-wrap items-center justify-between text-gray-100">
            ...
            <article class="w-full md:w-1/2 mt-8 md:mt-0 ">
              <div>
                <h2 class="text-xl font-bold mb-4">Пристрастен към ученето</h2>
                <p class="mb-4">
                  🚀 Като блогър, програмист и готвач съм ангажиран непрекъснато
                  с това да се усъвършенствам и развивам. Следя последните
                  технологии, както и последните тенденции в кулинарния свят.
                </p>
                <p>
                  📈 Чрез участие в събития свързани с програмирането, както и
                  кулинарни такива, общуване с колеги ентусиасти и изследване на
                  нови гледни точки, гарантирам, че моето съдържание остава
                  актуално и ценно.
                </p>
              </div>
              <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-3/4 m-auto">
          <div className="p-6 bg-pink-100 rounded-lg">
            ...
            <p className="text-gray-700">
              ...
              експертиза по различни теми. Следвайте ме за задълбочени статии и
          ...
          <div className="p-6 bg-pink-100 rounded-lg">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-lg font-bold text-pink-600">Web Developer</h2>
            </div>
            <p className="text-gray-700">
        ...
        <div className="mt-8 text-center">
          <p className="text-lg text-gray-100">
            Интересувате се от уебсайт или помощ в дигиталното пространство ? Не
            се колебайте да се свържете с мен!
          </p>
        </div>
